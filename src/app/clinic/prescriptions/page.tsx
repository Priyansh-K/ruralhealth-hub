...
export default function ClinicPrescriptionsPage() {
  ...
  const loadPrescriptions = async (page = 1) => {
    try {
      ...
      // For now, we'll simulate it by getting visits and extracting prescriptions
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">View all medications prescribed at your clinic</p>
      </div>
      ...
      <Card className="border-l-4 border-l-red-500">
        <CardHeader>
          ...
          <CardDescription>Complete record of all medications prescribed</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <>
                    ...
                    <TableRow key={prescription.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center">
                          ...
                          <span>{prescription.visit?.patient?.full_name}</span>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center">
              ...
              {pagination.total_pages > 1 && (
                <div className="flex items-center justify-between mt-4">
                  <p className="text-sm text-gray-600">Showing prescriptions from recent visits</p>
